...
import useConsultation from '../../contexts/useConsultations';
        ...
        <Card>
            <Card.Header>
                ...
                <div className="actions">
                    <Button variant="none" onClick={() => navigate('/consultations/create')}>
                        <Icon icon="mdi:plus" />
                        <span className="title">Dodaj Konsultację</span>
                    </Button>
                </div>
            </Card.Header>
            <Card.Body>
                {(consultations === undefined && <div className="loading">Ładowanie...</div>) || (
                    <>
